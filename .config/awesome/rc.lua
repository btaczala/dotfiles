...
tyrannical.tags = {
    ...
    } ,
    {
        ...
        class = {
            ...
            "Chromium"      , "Google-chrome-stable"        , "minefield"     }
    } ,
    {
        name        = "dev",
        init        = true,
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("pamixer --increase 7") end),
    awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("pamixer --decrease 7") end),
    awful.key({ }, "XF86AudioPrev", function () awful.util.spawn("mpc prev") end),
    awful.key({ }, "XF86AudioNext", function () awful.util.spawn("mpc next") end),
    awful.key({ }, "XF86AudioPlay", function () awful.util.spawn("mpc toggle") end),
    awful.key({ }, "XF86Battery", function () awful.util.spawn("backlight-control -c -5") end),
    awful.key({ }, "XF86Sleep", function () awful.util.spawn("backlight-control -c 5") end),
    awful.key({ }, "XF86Display", function () awful.util.spawn("sh /home/bata/touchpad.sh") end),
