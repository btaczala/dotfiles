...
theme.layout_tilegaps               = theme.confdir .. "/layouts/tile.png"
...
theme.layout_fullscreen             = theme.confdir .. "/layouts/max.png"
theme.layout_magnifier              = theme.confdir .. "/layouts/magnifier.png"
theme.layout_floating               = theme.confdir .. "/layouts/floating.png"
theme.layout_uselesstile            = theme.confdir .. "/layouts/tile.png"
theme.layout_uselesstileleft        = theme.confdir .. "/layouts/tileleft.png"
theme.layout_uselesstiletop         = theme.confdir .. "/layouts/tiletop.png"
theme.layout_uselesstilebottom      = theme.confdir .. "/layouts/tilebottom.png"
theme.layout_uselessfair            = theme.confdir .. "/layouts/fairv.png"
theme.layout_uselessfairh           = theme.confdir .. "/layouts/fairh.png"
theme.layout_termfair               = theme.confdir .. "/layouts/termfair.png"
theme.layout_uselesspiral           = theme.confdir .. "/layouts/spiral.png"
theme.layout_uselessdwindle         = theme.confdir .. "/layouts/dwindle.png"
